...
import com.active_india.invoice_pdf;
...
*/
    ...
    protected void cancel_order()
    {
            ...
            com.active_india.Fragment.cancel_order grid = new cancel_order();
    ...
    protected void repalce_order()
    {
        ...
        com.active_india.Fragment.replace_order grid = new replace_order();
